...
class constants:
    ...
    MixColumns = numpy.array([[0x02,0x03,0x01,0x01],
                              [0x01,0x02,0x03,0x01],
                              [0x01,0x01,0x02,0x03],
                              [0x03,0x01,0x01,0x02]])
    # MixColumns for decryption
    InverseMixColumns = numpy.array([[0x14, 0x11, 0x13, 0x9],
                                     [0x9, 0x14, 0x11, 0x13],
                                     [0x13, 0x9, 0x14, 0x11],
                                     [0x11, 0x13, 0x9, 0x14]])
    ...
    # Rijndael implementations pre-calculated lookup tables
