...
class AES_methods(object):
    ...
    def generate_roundKeys(self):
        ...
        for roundkeys_num in range(self.num_of_roundkeys):
            ...
            rotated_word = self.rot_word(self.RoundKey[roundkeys_num][3])
    ...
    @staticmethod
    def rot_word(word):
        # This does a circular shift i.e. just moves each byte of the word one space over
